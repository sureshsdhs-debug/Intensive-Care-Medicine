...
const GlobalPageSearch = () => {
  ...
  return (
    <div className="content-search-bar">
      ...
      <button onClick={prevMatch} className="text-light"><i className="bi bi-arrow-up"></i></button>
      <button onClick={nextMatch} className="text-light"><i className="bi bi-arrow-down"></i></button>
    </div>
  );
};
