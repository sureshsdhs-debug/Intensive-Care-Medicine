...
const Add = () => {
  ...
  const handleSubmit  = async (e)=>{
    ...
    try {
    const {data} = await axios.post(`${BACKEND_BASE_URL}/api/table-of-contents/add`,formData,
    ...
    <div className="main">
      <div className="report-container-1">
        <div className="report-header">
          <h1 className="recent-Articles"><i className="bi bi-plus-lg"></i> Add Table Of Contents</h1>
